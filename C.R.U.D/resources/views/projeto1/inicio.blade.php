...
@section ('title', 'Festival Musical')
                            ...
                            <form action="/music" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" name="email" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="idade" class="form-label">Idade</label name="nome">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="newsletter" name="novidades"value="S" required>
